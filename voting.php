...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        <div class='alert alert-secondary alert-dismissible fade show' style='margin-top:30px; margin-bottom:-20px; ' role='alert'>
            <strong>Welcome!</strong> Please choose and click the vote button.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
        <div class="row justify-content-around align-items-around" style="margin-bottom:50px">
            <div class="col align-items-around" align="center" style="margin-top:50px;">
            ...
            <div class="col align-items-around" align="center" style="margin-top:50px;">
                <div class="card" style="width: 30rem;">
                    <img src="vendor/calon2.jpg" height="318.59px" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary" style=" padding-left: 30px; padding-right: 30px"> Vote </a>
