        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pr-3 pl-3">
                    ...
                    ?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Daftar Pemilih Tetap</h1>
                    <p class="mb-4">Tambahkan mahasiswa yang telah memenuhi persyaratan sebagai Daftar Pemilih Tetap di bawah ini.</p>
