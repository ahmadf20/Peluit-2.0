    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Daftar TPS </h1>
          <p class="mb-4">Tabel di bawah ini berisi database Daftar Tempat Pemungutan Suara</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabel Data TPS</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                    ...
                    while ($data = $show->fetch(PDO::FETCH_OBJ)) {
                        ...
                        <td><a class='btn btn-outline-danger btn-sm' href='daftarTPS.php?delete=$data->Kode_TPS'><i class='fas fa-user-times'></i><a class='ml-2 btn btn-outline-secondary btn-sm' href='editTPS.php?kode=$data->Kode_TPS'><i class='fas fa-user-cog'></i></td>
                        </tr>";
                    };
                    ?>
                </tbody>
