                                ...
                                <table class="text-center table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = $show->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <td><a class='btn btn-outline-danger btn-sm' href='daftarKandidat.php?delete=$data->NPM'><i class='fas fa-user-times'></i><a class='ml-2 btn btn-outline-secondary btn-sm' href='editKandidat.php?kode=$data->NPM'><i class='fas fa-user-cog'></i></td>
                                            </tr>";
                                        };
                                        ?>
                                    </tbody>
...
<?php
    if (isset($_GET['delete'])) {
        $del = $Lib->deleteKandidat($_GET['delete']);
        if ($del == "Success") {
